...
var app = (function () {
    ...
    */
    ...
    // (29:3) {#each images as image, index}
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "alt", "");
    			attr_dev(img, "class", img_class_value = "image" + /*index*/ ctx[8] + " svelte-n2qbm1");
    			add_location(img, file, 30, 4, 981);
    			attr_dev(div, "data-depth", div_data_depth_value = /*index*/ ctx[8] + 0.6);
    			add_location(div, file, 29, 3, 945);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(29:3) {#each images as image, index}",
    		ctx
    	});
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			h1 = element("h1");
    			h1.textContent = "I am happening";
    			add_location(h1, file, 41, 45, 1290);
    			attr_dev(section, "id", "happening");
    			attr_dev(section, "class", "svelte-n2qbm1");
    			add_location(section, file, 41, 2, 1247);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment(ctx) {
    	...
    	let if_block = /*showHappening*/ ctx[0] && create_if_block(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(section0, "class", "svelte-n2qbm1");
    			add_location(section0, file, 25, 1, 625);
    			add_location(h3, file, 36, 2, 1085);
    			attr_dev(section1, "class", "svelte-n2qbm1");
    			add_location(section1, file, 35, 1, 1073);
    			attr_dev(div1, "id", "button");
    			attr_dev(div1, "class", "svelte-n2qbm1");
    			add_location(div1, file, 38, 1, 1120);
    			attr_dev(main, "class", "svelte-n2qbm1");
    			add_location(main, file, 24, 0, 617);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			dispose = [
    				action_destroyer(ready_action = /*ready*/ ctx[2].call(null, div0)),
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const click_handler = () => $$invalidate(0, showHappening = !showHappening);
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("showHappening" in $$props) $$invalidate(0, showHappening = $$props.showHappening);
    	};

    	return [showHappening, images, ready, parallaxInstance, scene, click_handler];
    }
